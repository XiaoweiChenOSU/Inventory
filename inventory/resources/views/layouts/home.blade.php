...
<head>
    ...
    <link rel="stylesheet" href="/css/weiself.css">
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        {{-- Navigation --}}
          ...
          <li class="treeview @if(Request::is('kit/*')) active @endif">
            <a href="#">
              <i class="fa fa-shopping-cart"></i> <span>Kits</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="@if(Request::is('kit/create')) active @endif"><a href="{{ url('/kit/create') }}"><i class="fa fa-circle-o"></i> Add Kits</a></li>
              <li class="@if(Request::is('kit/view')) active @endif"><a href="{{ url('/kit/view') }}"><i class="fa fa-circle-o"></i> View Kits</a></li>
            </ul>
          </li>
          
          <li class="treeview @if(Request::is('brand/*')) active @endif">
            <a href="#">
              <i class="fa fa-truck"></i> <span>Brand</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="@if(Request::is('brand/create')) active @endif"><a href="{{ url('/brand/create') }}"><i class="fa fa-circle-o"></i> Add Brand</a></li>
              <li class="@if(Request::is('brand/view')) active @endif"><a href="{{ url('/brand/view') }}"><i class="fa fa-circle-o"></i> View Brand</a></li>
            </ul>
          </li>
          
          <li class="treeview @if(Request::is('status/*')) active @endif">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="@if(Request::is('status/create')) active @endif"><a href="{{ url('/status/create') }}"><i class="fa fa-circle-o"></i> Add Status</a></li>
              <li class="@if(Request::is('status/view')) active @endif"><a href="{{ url('/status/view') }}"><i class="fa fa-circle-o"></i> View Status</a></li>
            </ul>
          </li>
          
          <li class="treeview @if(Request::is('classification/*')) active @endif">
            <a href="#">
              <i class="fa fa-truck"></i> <span>Classification</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="@if(Request::is('classification/create')) active @endif"><a href="{{ url('/classification/create') }}"><i class="fa fa-circle-o"></i> Add Classification</a></li>
              <li class="@if(Request::is('classification/view')) active @endif"><a href="{{ url('/classification/view') }}"><i class="fa fa-circle-o"></i> View Classification</a></li>
            </ul>
          </li>
          
          <li class="treeview @if(Request::is('item/*')) active @endif">
            <a href="#">
              <i class="fa fa-truck"></i> <span>Item</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="@if(Request::is('item/create')) active @endif"><a href="{{ url('/item/create') }}"><i class="fa fa-circle-o"></i> Add Item</a></li>
              <li class="@if(Request::is('item/view')) active @endif"><a href="{{ url('/item/view') }}"><i class="fa fa-circle-o"></i> View Item</a></li>
              <li class="@if(Request::is('item/audit')) active @endif"><a href="{{ url('/item/audit') }}"><i class="fa fa-circle-o"></i>Audit</a></li>
            </ul>
          </li>
          
          <li class="treeview @if(Request::is('attribute/*')) active @endif">
            <a href="#">
              <i class="fa fa-truck"></i> <span>Attribute</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li class="@if(Request::is('attribute/create')) active @endif"><a href="{{ url('/attribute/create') }}"><i class="fa fa-circle-o"></i> Add Attribute</a></li>
              <li class="@if(Request::is('attribute/view')) active @endif"><a href="{{ url('/attribute/view') }}"><i class="fa fa-circle-o"></i> View Attribute</a></li>
            </ul>
          </li>

          <li class="treeview @if(Request::is('product/*') || Request::is('category/*')) active @endif">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="@if(Request::is('product/create')) active @endif"><a href="{{ url('/product/create') }}"><i class="fa fa-circle-o"></i> Add Product</a></li>
              <li class="@if(Request::is('product/view')) active @endif"><a href="{{ url('/product/view') }}"><i class="fa fa-circle-o"></i> View Product</a></li>
              <li class="@if(Request::is('category/create')) active @endif"><a href="{{ url('/category/create') }}"><i class="fa fa-circle-o"></i> Add Product Category</a></li>
              <li class="@if(Request::is('category/view')) active @endif"><a href="{{ url('/category/view') }}"><i class="fa fa-circle-o"></i> View Product Category</a></li>
              <li class="@if(Request::is('product/view/availability')) active @endif"><a href="{{ url('/product/view/availability') }}"><i class="fa fa-circle-o"></i> View Product Availability</a></li>
            </ul>
          </li>
          ...
          <li class="treeview @if(Request::is('stock/*') || Request::is('category/*')) active @endif">
            ...
            <ul class="treeview-menu">
              <li class="@if(Request::is('stock/create')) active @endif"><a href="{{ url('/stock/create') }}"><i class="fa fa-circle-o"></i> Add Product</a></li>
              <li class="@if(Request::is('stock/view')) active @endif"><a href="{{ url('/stock/view') }}"><i class="fa fa-circle-o"></i> View Product</a></li> 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://www.nextgenuscorp.com/" target="_blank">NextGen Us Corp</a></strong>
  </footer>
