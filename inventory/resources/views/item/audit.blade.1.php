    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="box-body">
            <form class="form-horizontal create_audit" role="form" method="POST" action="{{ url('/item/audit') }}">
                        ...
                        <div class="box-body">
                          <div class="row">
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                <label>&nbsp;</label>
                                <button type="button" class="btn btn-block btn-default ">Show Items</button>
                              </div>
                            </div>
                          </div>
