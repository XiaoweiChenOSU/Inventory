    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-body">
            <form class="form-horizontal create_attribute" role="form" method="POST" action="{{ url('/attribute/store') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="attribute_name" placeholder="Full name">
                          </div>
                        </div>
                      </div>
                    </div>
