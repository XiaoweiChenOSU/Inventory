    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
          ...
          <div class="box-body">
            <form class="form-horizontal create_status" role="form" method="POST" action="{{ url('/status/store') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="status_name" placeholder="Full name">
                          </div>
                        </div>
                      </div>
                    </div>
