...
class StockController extends Controller
{
    ...
    public function create()
    {
        ...
        $location_details = \App\Models\WarehouseLocation::pluck('location_name','id');


        return view('stock.create')->with('category_details',$category_details)->with('supplier_details',$supplier_details)->with('warehouse_name',$warehouse_details)->with('location_details',$location_details);
    }
    ...
    public function audit(Request $request)
    {
        ...
        $location_details = \App\Models\WarehouseLocation::where('warehouse_id',$warehouse_id)->get();


        return view('stock.audit')->with('warehouse_details',$warehouse_details);
    }
